...
// Złożoność czasowa: O(n^4 / 64).
// Punkty: 100 (upsolve).

// BFS po grafie par pozycji agentów przyśpieszony bitsetami.
#include <bits/stdc++.h>
using namespace std;
...
int32_t main() {
    ...
    // Ciekawe czy to sie da ubić xd <- da się ~ja z przyszłości, for powinien być do MAXD,
